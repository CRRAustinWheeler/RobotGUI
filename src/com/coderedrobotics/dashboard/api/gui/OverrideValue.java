 ...
 * @author Michael
 */
public class OverrideValue extends javax.swing.JPanel implements RemoteDoubleListener {
    ...
    public void setup(String subsocketPath) {
        try {
            ...
            useOverride = new RemoteBoolean(subsocketPath + ".use", false);
            overrideValue = new RemoteDouble(subsocketPath + ".override", 0);
            originalValue = new RemoteDouble(subsocketPath + ".original", RemoteDouble.MODE.LOCAL);
            Debug.println("Original Value: " + originalValue.getValue(), Debug.EXTENDED);
            originalValue.addListener(this);
            //updateText(false);
